"""Semantic convention generation using Pydantic AI."""
...
try:
    ...
    # Ollama might not be available in all versions
    OllamaModel = None
...
class SemanticGenerator:
    """Generate semantic conventions using Pydantic AI agents."""
    ...
    def __init__(
        ...
        """Initialize semantic generator with AI model.
        
        Args:
            model: Model name (e.g., "gpt-4o" for OpenAI, "llama3.2" for Ollama)
        ...
        # Initialize AI model - always use Ollama
        if OllamaModel is None:
            raise ImportError(
                "Ollama model not available in this version of pydantic-ai. "
                "Please check pydantic-ai documentation for Ollama support."
            )
